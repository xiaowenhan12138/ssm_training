        ...
        <p class="spec">
            ...
            <c:forEach items="${listSeries}" var="series">
            	<c:if test="${series.goodsId==goods.id}">
					<a href="showGoodsInfo.do?id=${series.goodsId}&categoryId=${categoryId}" 
							class="avenge borderChange" style="border: 1px solid rgb(102, 102, 102); color: rgb(102, 102, 102);">
						${series.spec}
					</a>
            	</c:if>
            	<c:if test="${series.goodsId != goods.id}">
					<a href="showGoodsInfo.do?id=${series.goodsId}&categoryId=${categoryId}" 
							class="avenge" style="border: 1px solid rgb(102, 102, 102); color: rgb(102, 102, 102);">
						${series.spec}
					</a>
            	</c:if>
            </c:forEach>
